...
{"SCALE",		OPT_STR,			9,"volume of data to generate in GB; fractions below 1 shrink the dataset", SetScaleIndex, "1"}, 
...
{"_ROWCOUNT",	OPT_FLG|OPT_HIDE,	25, "print the row count of -TABLE at -SCALE and exit", NULL, "N"}, 
{NULL}
};
